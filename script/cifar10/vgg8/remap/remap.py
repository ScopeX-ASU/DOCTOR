...
root = "Experiment/log/cifar10/vgg8/remap_mode"
script = "scan_remap.py"
...
def task_launcher(args):
    ...
    with open(os.path.join(root, f"remap_{algo}_vgg8_{sparsity}_ns-{nsteps}_lr-{lr}_salience-{salience_mode}_pv-{PV_schedule}-{noise_scenario_src}-{noise_scenario_tgt}_td-{TD_schedule}-{hotspot}.log"), "w") as wfid:
        exp = [
