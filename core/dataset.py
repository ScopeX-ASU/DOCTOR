...
def get_dataset(dataset, img_height, img_width, dataset_dir="./data", transform=None):
    if dataset == "mnist":
        ...
        train_dataset = VowelRecog(
            os.path.join(dataset_dir, "vowel4_4/processed"), mode="train"
        )
        validation_dataset = VowelRecog(
            os.path.join(dataset_dir, "vowel4_4/processed"), mode="test"
        )
